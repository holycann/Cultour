  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-center p-4 justify-between">
        ...
        <Text className="text-xl font-bold text-[#4E7D79] flex-1 text-center">Identity Verification</Text>
      ...
      >
        ...
        <Text className="text-[#4E7D79] mb-4 text-sm">
          To validate the event creator as a verified local by submitting a form of identity, You can upload a valid form of identification such as a National ID (KTP), Driver's License (SIM), or Passport.
        </Text>
        ...
        <View className="mb-4">
          ...
          >
            <Icon 
              icon={isConfirmedIdentity ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline"} 
              width={24} 
              height={24} 
              color="#4E7D79" 
            />
            <Text className="ml-2 text-[#4E7D79] text-xs">
              I confirm that the uploaded identity document belongs to me and is valid.
            </Text>
          </TouchableOpacity>
          ...
          >
            <Icon 
              icon={isAgreedToTerms ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline"} 
              width={24} 
              height={24} 
              color="#4E7D79" 
            />
            <Text className="ml-2 text-[#4E7D79] text-xs">
              I agree that the platform may use my information solely for identity verification purposes.
            </Text>
          </TouchableOpacity>
          ...
          >
            <Icon 
              icon={isUnderstandMisleading ? "mdi:checkbox-marked" : "mdi:checkbox-blank-outline"} 
              width={24} 
              height={24} 
              color="#4E7D79" 
            />
            <Text className="ml-2 text-[#4E7D79] text-xs">
              I understand that submitting false or misleading information may result in the suspension of my account.
            </Text>
          </TouchableOpacity>
